    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-8 px-2 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Ou{' '}
          <Link to="/login" className="font-medium text-vinca-primary hover:text-vinca-secondary">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="acceptTerms" className="ml-2 block text-sm text-gray-900">
                J'accepte les{' '}
                <a href="#" className="font-medium text-vinca-primary hover:text-vinca-secondary">
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-vinca-primary hover:bg-vinca-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-vinca-primary"
              >
                S'inscrire
              </button>
            </div>
