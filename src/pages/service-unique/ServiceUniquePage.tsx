      ...
      <div className="min-h-screen bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          >
            ...
            <div>
              {currentCategory.id === "prod" && (
                <p className="mb-4 text-lg font-semibold text-blue-700 bg-blue-50 rounded-xl px-4 py-2">
                  Découvrez nos offres exclusives de production audiovisuelle !
                </p>
              )}
              {currentCategory.id === "visual" && (
                <p className="mb-4 text-lg font-semibold text-yellow-900 bg-yellow-100 rounded-xl px-4 py-2">
                  Découvrez nos solutions créatives en design et infographie !
                </p>
              )}
          ...
          <div className="grid grid-cols-3 grid-rows-3 gap-8">
            {currentCategory.services.slice(0, 9).map((service, index) => (
              <div
                ...
                className={
                  ...
                  + " rounded-2xl shadow-lg cursor-pointer overflow-hidden relative group hover:shadow-xl transition-all duration-300 flex flex-col"
                }
              >
                {service.popular && (
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
                  ...
                  <Select onChange={e => setValue("paymentMethod", e.target.value)}>
