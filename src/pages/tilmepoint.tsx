  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-fuchsia-900 to-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        {/* Header */}
        <div className="text-center text-xl font-semibold text-blue-200 mt-8 mb-4">
        ...
        >
          ...
          <motion.div
            className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl mb-6 shadow-lg"
          ...
          <motion.h1
            className="text-6xl font-extrabold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600 bg-clip-text text-transparent text-glow"
          ...
          <p className="text-xl text-slate-200 max-w-2xl mx-auto">
            <h1>Échangez vos points contre des récompenses exclusives</h1>
          </p>
        </motion.div>
        ...
        <motion.div className="mb-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
          <div className="flex items-center justify-center space-x-3 mb-8">
            ...
            <h2 className="text-3xl font-bold">Boutique de Récompenses</h2>
          </div>
